...
export default function Home() {
  ...
  return (
    <>
      ...
      <Section>
        <div className="grid overflow-hidden rounded-lg border border-white/10 bg-neutral-900 md:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="flex flex-col justify-center p-6 md:p-8">
            ...
            <h2 className="mt-3 text-3xl font-black text-white">
              Play darts at Malone&apos;s
            </h2>
            <p className="mt-4 leading-7 text-neutral-300">
              Casual darts nights and tournament-style brackets for regulars,
              downtown visitors, and anyone ready to throw. Ask the bartender
              about the next bracket.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <ButtonLink href="/darts-tournament">Darts Details</ButtonLink>
